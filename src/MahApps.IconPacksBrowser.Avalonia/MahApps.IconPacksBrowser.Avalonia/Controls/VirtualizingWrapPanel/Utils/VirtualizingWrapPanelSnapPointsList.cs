...
internal class VirtualizingWrapPanelSnapPointsList : IReadOnlyList<double>
{
    private const int ExtraCount = 2;
    private readonly RealizedWrappedElements _realizedElements;
    ...
    public VirtualizingWrapPanelSnapPointsList(RealizedWrappedElements realizedElements, int count, Orientation orientation,
        Orientation parentOrientation, SnapPointsAlignment snapPointsAlignment, double size)
    {
