...
public struct VirtualizationCacheLength : IEquatable<VirtualizationCacheLength>
{
    ...
    public VirtualizationCacheLength(double cacheBeforeViewport, double cacheAfterViewport)
    {
        ...
        {
            throw new ArgumentException("Value may not be NaN", nameof(cacheBeforeViewport));
        }

        if (double.IsNaN(cacheAfterViewport))
        {
            throw new ArgumentException("Value may not be NaN", nameof(cacheAfterViewport));
        }
    ...
    {
        get { return _cacheBeforeViewport; }
    }
    ...
    {
        get { return _cacheAfterViewport; }
    }
    ...
    {
        return $"{CacheBeforeViewport} - {CacheAfterViewport}";
    }
