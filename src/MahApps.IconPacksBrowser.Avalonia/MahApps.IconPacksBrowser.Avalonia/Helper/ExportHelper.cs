...
namespace MahApps.IconPacksBrowser.Avalonia.Helper;
    ...
    internal struct ExportParameters
    {
        ...
        internal ExportParameters(IIconViewModel icon)
        {
            ...
            this.PageWidth = "100"; // TODO: Settings.Default.IconPreviewSize.ToString(CultureInfo.InvariantCulture);
            this.PageHeight = "100"; // TODO: Settings.Default.IconPreviewSize.ToString(CultureInfo.InvariantCulture);
            this.FillColor = Colors.Black.ToString(); // TODO: Settings.Default.IconForeground.ToString(CultureInfo.InvariantCulture);
            this.Background = Colors.White.ToString(); // TODO:Settings.Default.IconBackground.ToString(CultureInfo.InvariantCulture);
            this.StrokeColor = Colors.Black.ToString(); // TODO:Settings.Default.IconForeground.ToString(CultureInfo.InvariantCulture);
            this.StrokeWidth = "0";
